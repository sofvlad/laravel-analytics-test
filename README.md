...
Данный сайт показывает статистику посещенных сайтов. Скрипт прикрепляется к любому сайту и производит отправку запроса на текущий сервис, который собирает информацию: IP, геоданные, user agent, время посещения.

Встраиваемый скрипт предоставляется на главной странице приложения.
